...
# Configurações - CAMINHOS CORRETOS
GRAFANA_URL="http://grafana_dashboard:3000"
API_KEY_FILE="./grafana/grafana_api_key.txt"  # 🔥 CAMINHO CORRIGIDO
...
if [ ! -f "$API_KEY_FILE" ]; then
    ...
    ls -la
    echo "📄 Arquivos em ./grafana/:"
    ls -la ./grafana/ || echo "Diretório grafana não encontrado"
    exit 1
fi
