...
def execute():
    ...
    print("🔧 Configuração do Database:")
    print(f"   Host: {Config_database.HOST}")
    print(f"   Port: {Config_database.PORT}")
    print(f"   Database: {Config_database.DATABASE}")
    print(f"   User: {Config_database.USER}")
    print(f"   Connection String: {Config_database.connection_string}")

    print("🔧 Configuração do Grafana:")
    print(f"   URL: {Config_grafana.URL}")
